...
Let's update the FinancialAnalysis component to pass the selected language to OpenAI for generating responses in the correct language.

<lov-code>
We need to modify the FinancialAnalysis component to use the language context and pass it to OpenAI:

<lov-write file_path="src/components/FinancialAnalysis.tsx">
import React from 'react';
import { Card } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Brain } from 'lucide-react';
