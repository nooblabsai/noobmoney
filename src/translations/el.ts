const elTranslations = {
  ...
  'auth.name': 'Όνομα',
  'auth.name.placeholder': 'Το όνομά σας',
  'auth.email': 'Email',
  'auth.email.placeholder': 'το.email.σας@example.com',
  'auth.password': 'Κωδικός',
  'auth.password.placeholder': 'Εισάγετε τον κωδικό σας',
  'auth.signup': 'Εγγραφή',
  'auth.signin': 'Σύνδεση',
  ...
  'enter.openai.key': 'Εισάγετε το OpenAI API key σας',
  'data.loaded.from.cloud': 'Τα δεδομένα φορτώθηκαν από το cloud',
  'sync.failed': 'Η συγχρονισμός απέτυχε',
  'sync.failed.description': 'Αποτυχία συγχρονισμού δεδομένων στο cloud',
  'login.to.sync': 'Συνδεθείτε για συγχρονισμό σε όλες τις συσκευές',
