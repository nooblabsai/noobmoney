export const elTranslations = {
  ...
  'auth.name': 'Όνομα',
  'auth.name.placeholder': 'Εισάγετε το όνομά σας',
  'auth.email': 'Email',
  'auth.email.placeholder': 'Εισάγετε το email σας',
  ...
  'auth.signin.description': 'Παρακαλώ συνδεθείτε για να συνεχίσετε',
  'auth.signup.description': 'Παρακαλώ εγγραφείτε για να συνεχίσετε',
